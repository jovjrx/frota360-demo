...
export const baseCalculator = new BaseCalculator();

// Para compatibilidade com nome antigo
export const commissionEngine = baseCalculator;
export class CommissionEngine extends BaseCalculator {}
