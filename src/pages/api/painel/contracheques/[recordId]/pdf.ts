 ...
 * 
 * ✅ ATUALIZADO: Usa função ÚNICA centralizada getProcessedWeeklyRecords(weekId, driverId)
 */
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    // ✅ Buscar dados usando função ÚNICA (sempre atualizado!)
    const recordDataArray = await getProcessedWeeklyRecords(weekId, driverId);
