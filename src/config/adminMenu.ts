    ...
    // ========== OPERAÇÕES ==========
    {
        ...
        submenu: [
            ...
            },
            {
                ...
                icon: FiFileText,
                description: 'documents_management',
                isSubmenu: true,
            },
        ],
    },
        ...
        submenu: [
            {
                ...
                href: '/admin/settings',
                icon: FiSettings,
                description: 'Configure SEO, cores, branding e mais',
                isSubmenu: true,
            },
            {
                id: 'integrations',
                ...
                icon: FiBarChart2,
                description: 'Gerenciar integrações com APIs',
                isSubmenu: true,
            },
            {
                id: 'users',
            ...
            },
            {
                ...
                icon: FiCheckCircle,
                description: 'Gerenciar páginas dinâmicas',
                isSubmenu: true,
            },
        ],
    },
