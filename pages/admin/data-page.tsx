          ...
          <TabPanels pt={6}>
            <TabPanel px={0}>
              <Stack spacing={6}>
                <Alert status="info" borderRadius="md">
                  <AlertIcon />
                  <Stack spacing={1}>
                    <AlertTitle>{t('weeklyDataSources.legend.title', 'Origem vs. Snapshot')}</AlertTitle>
                    <AlertDescription>
                      {t(
                        'weeklyDataSources.legend.description',
                        'Integrações mantêm o fluxo contínuo. Ao criar uma semana, você decide como o snapshot será preenchido.'
                      )}
                    </AlertDescription>
                  </Stack>
                </Alert>

                <Grid templateColumns={{ base: '1fr', xl: '280px 1fr 320px' }} gap={6} alignItems="stretch">
                  <GridItem>
                    <Card h="100%">
                      <CardHeader pb={3}>
                        <Stack spacing={2}>
            ...
            <TabPanel px={0}>
              <Stack spacing={6}>
                <HStack>
                  <Text fontSize="sm" color="gray.500">
                    {t('weeklyDataSources.integrations.subtitle', 'Configure credenciais, acompanhe saúde e execute testes em tempo real.')}
                  </Text>
                  <Spacer />
                  {isValidatingIntegrations && <Spinner size="sm" />}
                </HStack>
