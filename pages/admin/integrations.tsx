...
interface IntegrationsProps extends AdminPageProps {
  // Adicione props específicas aqui
}

export default function Integrations({ user, translations, locale }: IntegrationsProps) {
  const t = (key: string) => translations.admin[key] || key;

  return (
    <AdminLayout
      title="Integrações"
      subtitle="Gerencie APIs e integrações"
      breadcrumbs={[
        { label: 'Integrações' }
      ]}
    >
      <VStack spacing={6} align="stretch">
        <Card>
          <CardBody>
            <Text>Conteúdo da página Integrações</Text>
